...
<p className='text-2xl md:text-3xl lg:text-4xl text-white font-semibold leading-tight md:leading-tight lg:leading-tight'>
    Book Apponinment <br /> With Trested Doctors</p>
...
<div className="flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light ">
    ...
    <a href="#speciality" className='flex items-center gap-2 bg-white px-8 py-3 rounded-full text-sm m-auto md:m-0 text-gray-600 hover:scale-105 transition-all duration-300' >
